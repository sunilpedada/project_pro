                                                    ...
                                                    <div className="row">
                                                        <div className="col-sm-12">
                                                            <div className="table_grid">
                                                                ...
                                                                <hr/>
                                                                <p>You have not added a dataset yet. Please select one
                                                                    below or upload a new dataset.</p>
                                                                <table className="table table-bordered">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <a href="#"
                                                                               className="btn btn-dark">Attach</a>
                                                    ...
                                                    <div className="row">
                                                            ...
                                                            <div className="browse_box">
                                                                <input type="file" accept="" multiple=""
                                                                    ...
                                                                    <div className="browswe_text">
                                                                        ...
                                                                        <div className="sc-hwwEjo jkdGtr"><p>Drop files
                                                                            here to upload</p><p><em>- or -</em></p>
                                                                            <p>Drop a CSV or JSON file containing URLs
                                                                                to your data</p></div>
                                                                        <button className="btn btn-primary"
                                                                                type="button">choose files to upload
                                                                        </button>
                                                                    </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="col-sm-6">
                                                            ...
                                                            <div className="side_bar">
                                                                ...
                                                                <div className="adding_data"><h5><i
                                                                    className="fa fa-info-circle"
                                                                    aria-hidden="true"></i> Adding data</h5></div>

                                                                <ul className="nav nav-tabs">
                                                                    <li className="active"><a data-toggle="tab"
                                                                                              href="#list-add1">Local</a>
                                                                    </li>
                                                                    <li><a data-toggle="tab" href="#list-add2">Cloud</a>
                                                                    </li>
                                                                    <li><a data-toggle="tab" href="#list-add3">On
                                                                        Primise</a></li>
                                                                </ul>
                                                                ...
                                                                <div className="tab-content">
                                                                    <div id="list-add1"
                                                                        ...
                                                                        <h4>Select all the files you would like to
                                                                            upload.</h4>
                                                                        <p>Some content.</p>
                                                                    </div>
                                                                    <div id="list-add2" className="tab-pane fade">
                                                                        <h4>Create a JSON file containing the data URLs.
                                                                            For example, here is a JSON snippet for
                                                                            importing data hosted in Google
                                                                            Storage:</h4>
                                                                        <p>Some content in menu 1.</p>
                                                                    </div>
                                                                    <div id="list-add3" className="tab-pane fade">
                                                                        <h4>Labelbox provides the ability to keep all
                                                                            data on premise. If you opt into this
                                                                            option, data will never be shared or stored
                                                                            with Labelbox servers.</h4>
                                                        ...
                                                        <div className="col-sm-12"><a className="btn btn-dark"
                                                                                      href="#">Back</a>
